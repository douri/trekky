...
function Datepicker() {
	...
	this.regional[''] = { // Default regional settings
		...
		monthNames: ['Janvier','Février','Mars','Avril','Mai','Juin',
			'Juillet','Aaout','Septembre','Octobre','Novembre','Decembre'], // Names of months for drop-down and formatting
		monthNamesShort: ['Jan', 'Fev', 'Mar', 'Avr', 'Mai', 'Juin', 'Juil', 'Aou', 'Sep', 'Oct', 'Nov', 'Dec'], // For formatting
